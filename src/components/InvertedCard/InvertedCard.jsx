...
const InvertedCard = () => {
  return (
    <motion.div className="h-full w-fit bg-gray-900 rounded-[36px] p-4 md:p-6 mx-auto shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
      <div className="rounded-2xl overflow-hidden h-full mb-4 relative min-w-[500px] min-h-[650px]">
        <div className="absolute left-1 top-1 rounded-full bg-gray-900 z-50">
          <p className="bg-lime-500 text-gray-900 md:text-xl font-semibold px-8 py-1 rounded-full">
            2023
          </p>
        </div>
        <svg
        ...
        <div className="flex flex-row justify-between items-center w-full absolute bottom-4 px-6">
          <div className="flex flex-row  gap-3">
            <p className="px-3 py-1 text-sm text-white h-fit bg-neutral-500/20 backdrop-blur-sm rounded-full items-center">
              Technology
            </p>
            <p className="px-3 py-1 text-sm text-white h-fit bg-neutral-500/20 backdrop-blur-sm rounded-full items-center">
              Electronics
          ...
          <button className="duration-300 ease-in-out rounded-full p-2 text-white bg-gray-900 hover:bg-lime-500">
            <TbArrowUpRight size={26} />
          </button>
        </div>
      </div>
